import './style.css';
const PROFILE = {"day":"Day058","title":"Fridge Rescue Menu Palette","display_name_ja":"先食べ献立パレット","one_sentence":"冷蔵庫の期限近い食材から今夜の組み合わせを決めるツール","purpose_line_ja":"期限の近い食材から使う順を決めやすくするためのツールです。","use_case_line_ja":"夕方に冷蔵庫を開けても何から使うか迷う時に使います。","how_it_works_line_ja":"食材と残り日数を入れると、今夜優先の組み合わせが分かります。","core_action":"combine","family":"fridge_rescue_menu","mechanic":"combo_filter","input_style":"ingredient_cards","output_style":"meal_combo_cards","output_label":"ここを見ればOKです","audience_promise":"今夜何を先に使うかをすぐ決められる。","publish_hook":"食材と残り日数を自分で追加・編集すると、優先食材と成立する組み合わせが同時に見える。","engine":"brief_driven","interaction_archetype":"combo_filter","page_archetype":"fridge_shelf","ui_variant":"expiry","intro_variant":"expiry_shelf","interaction_model":"edit_ingredients_and_combo_cards","primary_layout":"ingredient_rows_with_combo_priority_stack","result_presentation_style":"urgent_ingredients_and_survivor_meals","palette_motif":"先食べアンバー","main_cta":"冷蔵庫の夕飯で試す","input_panel_title":"食材と残り日数を足す","sample_panel_title":"冷蔵庫の夕飯で試す","guide_panel_title":"先に使う見どころ","hero_panel_label":"今夜の食べ切り候補","output_shape":"fridge_shelf","state_model":"combo_filter_state","core_loop":"ingredient_cards -> combo_filter -> meal_combo_cards","component_pack":"fridge_shelf+meal_combo_cards","scaffold_id":"brief_canvas","single_shot_text_generator":false};
