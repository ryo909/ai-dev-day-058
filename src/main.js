import './style.css';
const PROFILE = {"day":"Day058","title":"Fridge Rescue Menu Palette","display_name_ja":"先食べ献立パレット","one_sentence":"冷蔵庫の期限近い食材から今夜の組み合わせを決めるツール","purpose_line_ja":"期限の近い食材から使う順を決めやすくするためのツールです。","use_case_line_ja":"夕方に冷蔵庫を開けても何から使うか迷う時に使います。","how_it_works_line_ja":"食材と残り日数を入れると、今夜優先の組み合わせが分かります。","core_action":"combine","family":"fridge_rescue_menu","mechanic":"combo_filter","input_style":"ingredient_cards","output_style":"meal_combo_cards","output_label":"ここを見ればOKです","audience_promise":"今夜何を先に使うかをすぐ決められる。","publish_hook":"食材と残り日数を自分で追加・編集すると、優先食材と成立する組み合わせが同時に見える。","engine":"brief_driven","interaction_archetype":"combo_filter","page_archetype":"fridge_shelf","ui_variant":"generic","intro_variant":"generic","interaction_model":"structured_multi_field","primary_layout":"two_column_workbench","result_presentation_style":"stacked_result_cards","palette_motif":"neutral slate / white","main_cta":"サンプルで試す","input_panel_title":"まず試す入力","sample_panel_title":"サンプルで試す","guide_panel_title":"使い方のコツ","hero_panel_label":"結果の見どころ","output_shape":"fridge_shelf","state_model":"combo_filter_state","core_loop":"ingredient_cards -> combo_filter -> meal_combo_cards","component_pack":"fridge_shelf+meal_combo_cards","scaffold_id":"card_deck_board","single_shot_text_generator":false};
